...
public sealed class SlashCooldownAttribute(int maxUses, double resetAfter, SlashCooldownBucketType bucketType) : SlashCheckBaseAttribute
{
    /// <summary>
    ...
    /// </summary>
    public SlashCooldownBucketType BucketType { get; } = bucketType;
