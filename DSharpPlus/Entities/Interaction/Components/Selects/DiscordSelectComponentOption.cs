...
/// </summary>
public sealed class DiscordSelectComponentOption(string label, string value, string description = null, bool isDefault = false, DiscordComponentEmoji emoji = null)
{
    /// <summary>
    ...
    public bool Default { get; internal set; } = isDefault;
    ...
    public DiscordComponentEmoji Emoji { get; internal set; } = emoji;
}
